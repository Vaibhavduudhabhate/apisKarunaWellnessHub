...
async function addDummyProducts() {
    ...
    const dummyProducts = [
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `1. BURN FATS IN BODY
            2. REDUCE WEIGHT
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1599 ₹",
            Product_description_english: `1 Gum: Improves digestion and helps control sugar levels in diabetics. 2. Turmeric: Helps wound healing in diabetics. Reduces urinary tract infections. 
            ...
            Product_description_hindi: `1. गोंद: पाचन में सुधार करता है और मधुमेह रोगियों में शर्करा के स्तर को नियंत्रित करने में मदद करता है 

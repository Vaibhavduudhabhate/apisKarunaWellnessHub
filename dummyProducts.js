    ...
    const dummyProducts = [
        {
            ...
            Product_price: "175 ₹",
            Product_description_english: `/REDUCES THE ABDOMINAL CRAMPS DURING MENSTRUATION
            ...
            Product_description_hindi: `/मासिक धर्म के दौरान पेट में ऐंठन को कम करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "175 ₹",
            Product_description_english: `/IT KEEPS YOU DRY AND FRESH ALL DAY. IT PROVIDES EVERYDAY PROTECTION FROM URINE LEAKAGE, VAGINAL DISCHARGE, OR AN UNEXPECTED PERIOD
            ...
            Product_description_hindi: `/यह आपको पूरे दिन सूखा और तरोताजा रखता है
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `/HELPS IN LOSING WEIGHT, IMPROVES GUT HEALTH, LOWERS CHOLESTEROL
            ...
            /ANTITOXIC ACTION`,
            Product_description_hindi: `/वजन कम करने में मदद करता है, आंत के स्वास्थ्य में सुधार करता है, कोलेस्ट्रॉल कम करता है
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `/IT IMPROVES BLOOD FLOW, LOWERS OXIDATIVE STRESS IN SMOKERS.
            ...
            Product_description_hindi: `/यह रक्त प्रवाह में सुधार करता है, धूम्रपान करने वालों में ऑक्सीडेटिव तनाव को कम करता है।
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `/SEXUAL ENHANCEMENT SUPPLEMENT REDISCOVER PASSION, DESIRE AND FEELINGS OF AROUSAL WITH YOUR PARTNER
            ...
            Product_description_hindi: `/यौन वृद्धि पूरक अपने साथी के साथ जुनून, इच्छा और उत्तेजना की भावनाओं को फिर से खोजें
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `/THE INGREDIENTS THAT GO INTO FORMULATING STEMOGREENA MARE 100% NATURAL. IT HELP IN INCREASING ENERGY LEVELS IN MALES, ACTS AS A STAMINA BOOSTER, ENERGY BOOSTER, AND CONFIDENCE BOOSTER AND IMPROVES PERFORMANCE
            ...
            Product_description_hindi: `/स्टैमोग्रीना एम को तैयार करने में उपयोग होने वाली सामग्री 100% प्राकृतिक हैं। यह पुरुषों में ऊर्जा के स्तर को बढ़ाने में मदद करता है, एक सहनशक्ति बूस्टर, ऊर्जा बूस्टर, आत्मविश्वास बूस्टर के रूप में कार्य करता है और प्रदर्शन में सुधार करता है
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `HEALTH BENEFITS:
            ...
            Product_description_hindi: `बेरी प्लस के स्वास्थ्य लाभ ः
        ...
        },
        {
            ...
            Product_varient: "",
            Product_tagline:"",
            Product_description_english: `/HELPS IN TREATING ANY INFECTION ITCHING AND PREVENTS THEM FROM HAPPENING AGAIN.
            ...
            Product_description_hindi: `/खुजली के किसी भी संक्रमण का इलाज करने में मदद करता है और उन्हें दोबारा होने से रोकता है।
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "500 ₹",
            Product_description_english: `/TO AVOID ITCHES IN THE VAGINA IT IS RECOMMENDED TO REGULARLY USE VAGINAL WASH
            /INTIMATE WASH KEEPS THE PH LEVEL BALANCED AND PROTECTS THE VAGINA FROM INFECTIONS AND INFLAMMATIONS`,
            Product_description_hindi: `/योनि में खुजली से बचने के लिए नियमित रूप से प्रोकेयर स्प्रे का उपयोग करने की सलाह दी जाती है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "120 ₹",
            Product_description_english: `/PURE ALOE VERA GEL IS USED IN THIS
            ...
            Product_description_hindi: `/इसमें शुद्ध एलोवेरा जेल का इस्तेमाल किया जाता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "300 ₹",
            Product_description_english: `/OUR CELLULITE GEL COMES IN A GORGEOUS ORANGE COLOR. THIS PRODUCT REDUCES CELLULITE, TIGHTENS & FIRMS SKIN, IMPROVES BLOOD CIRCULATION IN AFFECTED PARTS, TONES MUSCLES & MOBILIZE UNWANTED FAT
            ...
            Product_description_hindi: `/हमारा सेल्युलाईट जेल एक भव्य नारंगी रंग में आता है। यह उत्पाद सेल्युलाईट को कम करता है, त्वचा को कसता है और फर्म करता है, प्रभावित हिस्सों में रक्त परिसंचरण में सुधार करता है, मांसपेशियों को टोन करता है और अवांछित वसा को जुटाता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `/IT HELPS IN TREATING BLEEDING PILES
            ...
            Product_description_hindi: `/यह खूनी बवासीर के इलाज में मदद करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `/HELPS IN ALL KIND OF KIDNEY STONE PIANS
            ...
            Product_description_hindi: `/सभी प्रकार की किडनी स्टोन पियान्स में मदद करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `/DETOXIFY THE LIVER AND KIDNEYS
            ...
            Product_description_hindi: `/लीवर और किडनी को डिटॉक्स करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `/HELPS IN ATHEROSCLEROSIS (HARDING OF VEINS AND ARTARIES)
            /HELPS TO LOWER LDL
            /HELPS TO IMPROVE HDL
            /HELPS TO MAINTAIN BLOOD FLOW
            /HELPS TO PURIFY BLOOD`,
            Product_description_hindi: `/एथेरोस्क्लेरोसिस (नसों और धमनियों का सख्त होना) में मदद करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `/BURN FATS IN BODY
            /REDUCE WEIGHT
            /IMPROVE METABOLISM
            /SOURCE OF NATURAL FIBERS
            /REDUCE BELLY FAT IN VERY LESS PERIOD`,
            Product_description_hindi: `/शरीर की चर्बी को कम करता है
            /वजन कम करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1200 ₹",
            Product_description_english: `ADVANTAGES:
            /ALL BODY DETOXIFIER
            /IMMUNITY BOOSTER
            /ALL KIND OF JOINT PAIN
            /RHEUMATOID ARTHRITES PAIN
            /OSTEOARTHRITIS PAIN
            /MUSCLE PAIN
            /DIABETIS
            /KIDNEY STONE
            ...
            /BLOOD PURIFIER
            /DIGETSION
            /ALL VITAL ORGAN PROTECTION
            /SUPER ANTIOXIDANT
            /SKIN GLOW
            /HAIR FALL`,
            Product_description_hindi: `/संपूर्ण शरीर विषहरणकारी
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "750 ₹",
            Product_description_english: `/IT HELPS TO MAKE BONES STRONG
            ...
            Product_description_hindi: `/यह हड्डियों को मजबूत बनाने में मदद करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1599 ₹",
            Product_description_english: `/SUGAR CAPSULES ARE A NATURAL PRODUCT.
            ...
            Product_description_hindi: `/शुगर कैप्सूल एक प्राकृतिक उत्पाद है।
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1599 ₹",
            Product_description_english: `/HELPS CHILDREN DEVELOP A GOOD APPETITE.
            ...
            Product_description_hindi: `/बच्चों को अच्छी भूख विकसित करने में मदद करता है।
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "900 ₹",
            Product_description_english: `/Helps heal wounds caused by diabetes.
            ...
            Product_description_hindi: `/मधुमेह के कारण हुए घावों को ठीक करने में मदद करता है
        ...
        },
        {
            ...
            Product_image: `data:image/jpeg;base64,${fs.readFileSync(path.join(assetsPath, "healthforce.png")).toString("base64")}`,
            Product_price: "1599 ₹",
            Product_description_english: `/Gum: Improves digestion and helps control sugar levels in diabetics. /Turmeric: Helps wound healing in diabetics. Reduces urinary tract infections. 
            /Ashwagandha: Protects against diabetes by reducing the sugar level in the body. 
            /Gulvel is beneficial in controlling blood sugar levels. So diabetes can be prevented. Increases immunity. 
            / Gudmar (Mandulashini): Helps the body to better control blood glucose levels through several mechanisms. According to the NIH, the gymnemic acid in it inhibits glucose absorption and delays sugar spikes. 
            /Neem: Neem helps in controlling diabetes. It controls hypoglycemic blood sugar. 
            /Fenugreek: Contains probiotics. These properties reduce bad cholesterol in the body without affecting it. Apart from this, they also work to lower blood sugar levels, thereby preventing the risk of diabetes. Fenugreek seeds contain alkaloids, which are known as a panacea for diabetes: 
            /Jira: Used to soothe the digestive system, relieve nausea and constipation as a remedy for stomach problems. Also, they are regularly used for digestion, but cumin is also used as an adjunctive treatment along with medication for people with type 2 diabetes 
            /Goharu: Helps lower blood sugar levels. Protects kidneys in diabetic patients.`,
            Product_description_hindi: `/गोंद: पाचन में सुधार करता है और मधुमेह रोगियों में शर्करा के स्तर को नियंत्रित करने में मदद करता है 
            /हल्दीः मधुमेह रोगियों में घाव स्रने में मदद करती है। मूत्र पथ के संक्रमण को कम करती है 
            /अश्वगंधाः शरीर में शुगर लेवल को कम करके डायबिटीज से बचाता है 
            /गुलवेल ब्लड शुगर लेवल को नियंत्रित करने में फायदेमंद है तो मधुमेह से बचा जा सकता है रोग प्रतिरोधक क्षमता बढ़ाता है 
            /गुहमार (मंडलाशिनी): शरीर को कई तंत्रों के माध्यम से रक्त शर्करा के स्तर को बेहतर ढंग से नियंत्रित करने में मदद करता है। एनआईएच के अनुसार, इसमें मौजूद जिम्नेमिक एसिड ग्लूकोज अवशोषण को रोकता है और शुगर बढ़ने में देरी करता है 
            /नीमः नीम मधुमेह को नियंत्रित करने में मदद करता है। यह हाइपोग्लाइसेमिक ब्लड शुगर को नियंत्रित करता है। 
            /मेथीः इसमें प्रोबायोटिक्स होते हैं। ये गुण शरीर में खराब कोलेस्ट्रॉल को बिना प्रभावित किए कम करते हैं। इसके अलावा, ये रक्त शर्करा के स्तर को कम करने का भी काम करते हैं, जिससे मधुमेह के खतरे को रोका जा सकता है। मेथी के दानों में एल्कलॉइड्स पाए जाते हैं, जो मधुमेह के लिए रामबाण माने जाते हैं: 
            /जीराः पेट की समस्याओं के इलाज के रूप में पाचन तंत्र को शांत करने, मतली और कब्ज से राहत देने के लिए उपयोग किया जाता है। इसके अलावा, इन्हें नियमित रूप से पाचन के लिए उपयोग किया जाता है, लेकिन टाइप 2 मधुमेह वाले लोगों के लिए दवा के साथ-साथ जीरे का उपयोग सहायक उपचार के रूप में भी किया जाता है 
            /गोहारुः रक्त शर्करा के स्तर को कम करने में मदद करता है। मधुमेह के रोगियों में गुर्दे की रक्षा करता है।`
        },
    ];
